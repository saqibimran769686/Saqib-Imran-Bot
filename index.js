/**
 * Saqib Imran Bot - A WhatsApp Bot
 * Copyright (c) 2025 Saqib Imran
 * 
...
async function startXeonBotInc() {
                    ...
                    await XeonBotInc.sendMessage(mek.key.remoteJid, { 
                        ...
                        contextInfo: {
                            ...
                            forwardedNewsletterMessageInfo: {
                                ...
                                newsletterName: 'Saqib Imran Bot',
                                serverMessageId: -1
                            }
                        }
                    }).catch(console.error);
    ...
    XeonBotInc.ev.on('connection.update', async (s) => {
        ...
        if (connection == "open") {
            ...
            console.log(chalk.magenta(`\n${global.themeemoji || '•'} WA Group: TalkNest`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} WA Channel: TalkNest`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} WA NUMBER: ${owner}`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} CREDIT: Saqib Imran`))
